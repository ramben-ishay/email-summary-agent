...
No new articles were found in your newsletters from the past 8 hours.
...
def main(email_limit: Optional[int] = None):
    ...
    # Step 1: Fetch emails from the last 8 hours
    print("\n[Step 1] Fetching emails from the last 8 hours...")
    emails = fetch_emails_from_last_n_hours(hours=8, limit=email_limit)
